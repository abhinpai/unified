...
export function AppSidebar({ ...props }: React.ComponentProps<typeof Sidebar>) {
  ...
  return (
    <Sidebar collapsible='icon' {...props}>
      ...
      <SidebarContent>
        <NavPrimary
          items={items.primaryNavItems}
          title={items.primaryNavItemTitle}
        />
        <NavSecondary
          items={items.secondaryNavItems}
          title={items.secondaryNavItemTitle}
        />
        <NavTertiary items={items.tertiaryNavItems} className='mt-auto' />
      </SidebarContent>
      <SidebarFooter>
